...
public class SensorReader implements SensorEventListener {
    ...
    public boolean startCollection() throws IOException {
        try {
            File localStorage = this.mContext.getExternalCacheDir();
            ...
            boolean file_success = file.createNewFile();
            Log.e("SensorReader", "file_success: " + file_success);
